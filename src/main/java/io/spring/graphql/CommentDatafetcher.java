...
public class CommentDatafetcher {
  ...
  private Comment buildCommentResult(CommentData comment) {
    return Comment.newBuilder()
        ...
        .updatedAt(comment.getCreatedAt().withZoneSameInstant(ZoneOffset.UTC).format(DateTimeFormatter.ISO_OFFSET_DATE_TIME))
        .createdAt(comment.getCreatedAt().withZoneSameInstant(ZoneOffset.UTC).format(DateTimeFormatter.ISO_OFFSET_DATE_TIME))
        .build();
  }
}
