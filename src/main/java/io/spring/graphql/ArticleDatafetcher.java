...
public class ArticleDatafetcher {
    ...
    return io.spring.graphql.types.PageInfo.newBuilder()
        ...
        .endCursor(
            articles.getEndCursor() == null
                ? null
                : articles.getEndCursor().toString())
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(articleData.getCreatedAt().atOffset(ZoneOffset.UTC)))
        ...
        .updatedAt(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(articleData.getUpdatedAt().atOffset(ZoneOffset.UTC)))
        .build();
  }
}
